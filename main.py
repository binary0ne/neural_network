...
"data_2": {"matrix": [1, 1, 0, 1], "expected": 1},
"data_3": {"matrix": [0, 1, 0, 0], "expected": 1},
"data_4": {"matrix": [0, 1, 0, 1], "expected": 1},
"data_5": {"matrix": [0, 1, 0, 0], "expected": 1},
"data_6": {"matrix": [0, 0, 0, 1], "expected": 0},
"data_7": {"matrix": [1, 0, 1, 1], "expected": 0},
}
